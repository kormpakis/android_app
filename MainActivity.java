...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.logout:
                ...
                //this.finish();
                break;
            case R.id.ontology_picks:
                //sessionManager.logout();
                Intent x = new Intent(MainActivity.this, YourBands.class);
    ...
    private void parseJSON() {
        ...
        //META APLA PERNAME TO mName STO URL TOY ROUTE WS PARAMETRO
        String url = "https://straightonmusic.com/wp-json/wp/v2/posts";
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        JsonObjectRequest article_media_request = new JsonObjectRequest(Request.Method.GET, article_media_url, null, new Response.Listener<JSONObject>() {
                            ...
                            public void onResponse(JSONObject response) {
                                try {
                                    ...
                                    mExampleAdapter = new ExampleAdapter(MainActivity.this, mExampleList, mExampleList);
                        ...
                        mRequestQueue.add(article_media_request);
